...
git remote add github https://$GITHUB_TOKEN@github.com/FEMessage/el-semver-input.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/FEMessage/el-semver-input/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "el-semver-input更新", "text": "@所有人\n# [el-semver-input('$version')]('$html_url')\n'$body'"}}'
